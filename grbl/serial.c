...
uint8_t serial_get_rx_buffer_available()
{
    ...
    {
        _return = (RX_BUFFER_SIZE - (serial_rx_buffer_head - rtail)); 
    }
    else
    {

        _return = ((rtail - serial_rx_buffer_head - 1));
    }
...
uint8_t serial_get_rx_buffer_count()
{
    ...
    if (serial_rx_buffer_head >= rtail) 
    {
        _return = (serial_rx_buffer_head - rtail);
    }
    else
    {
        _return = (RX_BUFFER_SIZE - (rtail - serial_rx_buffer_head));
    }
    SREG = status;
